...
save(dgm.contrl.base, dgm.contrl.actv, dgm.dreadd.base, dgm.dreadd.actv, file = file.path(PATH_RESULTS, sprintf('DGM-%s.RData', INFO)), compress = T)
```
### Load from RData
```{r}
...
p3 = gplotMat((stats.contrl.actv$adj - stats.contrl.base$adj) * !is.na(stats.prop.contrl$z_uncorr), title = "active-baseline",
              barWidth = 0.3, colMapLabel = "%",
              nodeLabels = mylabels, xAngle = 90, axisTextSize = 7, lim = mylim, gradient = c("blue", "white", "red")) +
  scale_x_continuous(breaks = 0.5:br, labels = mylabels)
...
p6 = gplotMat((stats.dreadd.actv$adj - stats.dreadd.base$adj) * !is.na(stats.prop.dreadd$z_uncorr), title = "active-baseline",
              barWidth = 0.3, colMapLabel = "%",
              nodeLabels = mylabels, xAngle = 90, axisTextSize = 7, lim = mylim, gradient = c("blue", "white", "red")) +
  scale_x_continuous(breaks = 0.5:br, labels = mylabels)

p7 = gplotMat((stats.dreadd.base$adj - stats.contrl.base$adj) * !is.na(stats.prop.base$z_uncorr), title = "dreadd-control",
              barWidth = 0.3, colMapLabel = "%",
              nodeLabels = mylabels, xAngle = 90, axisTextSize = 7, lim = mylim, gradient = c("blue", "white", "red")) +
  scale_x_continuous(breaks = 0.5:br, labels = mylabels)

p8 = gplotMat((stats.dreadd.actv$adj - stats.contrl.actv$adj) * !is.na(stats.prop.actv$z_uncorr), title = "dreadd-control",
              barWidth = 0.3, colMapLabel = "%",
              nodeLabels = mylabels, xAngle = 90, axisTextSize = 7, lim = mylim, gradient = c("blue", "white", "red")) +
  scale_x_continuous(breaks = 0.5:br, labels = mylabels)

plot_grid(p1, p2, p3, p4, p5, p6, p7, p8, ncol = 3, nrow = 3, rel_widths = c(1, 1))
